    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-violet-50 via-white to-indigo-50 dark:from-gray-950 dark:via-gray-900 dark:to-violet-950 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-800 p-8">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 text-center mb-8">Get 5 free HD credits when you sign up</p>
          ...
          <div className="mt-5 p-3 bg-violet-50 dark:bg-violet-950/30 rounded-xl">
            <p className="text-xs text-violet-600 dark:text-violet-400 text-center font-medium">
              You&apos;ll get 5 free HD credits instantly after signup
            </p>
          </div>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
          ...
          <Link href="/login" className="text-violet-600 dark:text-violet-400 font-semibold hover:underline">Log in</Link>
        </p>
